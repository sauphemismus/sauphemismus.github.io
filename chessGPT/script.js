...
function generate() {
  ...
  query({
    inputs:
      "Toilet Variation*Monkey's Bum*Hillbilly Attack*Frankenstein-Dracula Variation*Hippopotamus Defense*Orangutan*Flick-Knife Attack*Drunken Knights Opening*Banzai-Leong Gambit*Black Knights Tango*Clarendon Court Defense*Coca-cola Gambit*Creepy Crawly Formation*Damiano Defense*Double-Duck Formation*Forgotten Variation*Pork Chop Opening*Fried Fox*Nescafe Frappe Attack*Paleface Attack*Sodium Attack*Sturm Gambit*Potato*Tortoise Opening*Vulture Benoni Defense",
